...
/*****************************************************************************
 ...
 Called By    :
  ...
  1.Date         : 2013/07/24
    ...
    Modification : Created function
*****************************************************************************/
HI_S32 HI_MPI_VGS_AddScaleTask(VGS_HANDLE hHandle, VGS_TASK_ATTR_S *pstTask, VGS_SCLCOEF_MODE_E enScaleCoefMode);
...
/*****************************************************************************
 ...
 Called By    :
  ...
  1.Date         : 2014/01/27
    ...
    Modification : Created function
*****************************************************************************/
HI_S32 HI_MPI_VGS_AddRotationTask(VGS_HANDLE hHandle, VGS_TASK_ATTR_S *pstTask, ROTATION_E enRotationAngle);
