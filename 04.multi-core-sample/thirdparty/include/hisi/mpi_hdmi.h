...
HI_S32 HI_MPI_HDMI_RegCECCallBackFunc(HI_HDMI_ID_E enHdmi, HI_HDMI_CECCALLBACK_FUNC_S *pstCECCallback);
HI_S32 HI_MPI_HDMI_UnRegCECCallBackFunc(HI_HDMI_ID_E enHdmi, HI_HDMI_CECCALLBACK_FUNC_S *pstCECCallback);
HI_S32 HI_MPI_HDMI_SetCECCommand(HI_HDMI_ID_E enHdmi, HI_HDMI_CEC_CMD_S *pCECCmd);
...
/* Module Parameter */
HI_S32 HI_MPI_HDMI_SetModParam(HI_HDMI_ID_E enHdmi, HI_HDMI_MOD_PARAM_S *pstModParam);
