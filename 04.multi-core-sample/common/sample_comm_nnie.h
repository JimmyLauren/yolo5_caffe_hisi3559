...
typedef struct hiSAMPLE_SVP_NNIE_SSD_SOFTWARE_PARAM_S
{
	...
	HI_FLOAT af32PriorBoxMinSize[6][6]; //jimmy
	HI_FLOAT af32PriorBoxMaxSize[6][6]; //jimmy
	HI_U32 u32MinSizeNum[6];  //jimmy
	HI_U32 u32MaxSizeNum[6];  //jimmy
	HI_U32 u32OriImHeight;
	HI_U32 u32OriImWidth;
	HI_U32 au32InputAspectRatioNum[6];
	HI_FLOAT af32PriorBoxAspectRatio[6][6]; //jimmy
