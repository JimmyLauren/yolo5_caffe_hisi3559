...
HI_S32 HI_MPI_DPU_RECT_LoadLut(const HI_CHAR *pchFileName,
    DPU_RECT_MEM_INFO_S *pstLutMem, DPU_RECT_LUT_ID *pDpuRectLutId);
HI_S32 HI_MPI_DPU_RECT_UnloadLut(DPU_RECT_LUT_ID DpuRectLutId);

HI_S32 HI_MPI_DPU_RECT_CreateGrp(DPU_RECT_GRP DpuRectGrp, DPU_RECT_GRP_ATTR_S *pstGrpAttr);
HI_S32 HI_MPI_DPU_RECT_DestroyGrp(DPU_RECT_GRP DpuRectGrp);

HI_S32 HI_MPI_DPU_RECT_SetGrpAttr(DPU_RECT_GRP DpuRectGrp, DPU_RECT_GRP_ATTR_S *pstGrpAttr);
HI_S32 HI_MPI_DPU_RECT_GetGrpAttr(DPU_RECT_GRP DpuRectGrp, DPU_RECT_GRP_ATTR_S *pstGrpAttr);

HI_S32 HI_MPI_DPU_RECT_SetChnAttr(DPU_RECT_GRP DpuRectGrp, DPU_RECT_CHN DpuRectChn, DPU_RECT_CHN_ATTR_S *pstChnAttr);
...
HI_S32 HI_MPI_DPU_RECT_ReleaseFrame(DPU_RECT_GRP DpuRectGrp, VIDEO_FRAME_INFO_S *pstSrcLeftFrame,
    VIDEO_FRAME_INFO_S *pstSrcRightFrame, VIDEO_FRAME_INFO_S *pstDstLeftFrame,
    VIDEO_FRAME_INFO_S *pstDstRightFrame);

HI_S32 HI_MPI_DPU_RECT_SendFrame(DPU_RECT_GRP DpuRectGrp, VIDEO_FRAME_INFO_S *pstLeftFrame,
    VIDEO_FRAME_INFO_S *pstRightFrame, HI_S32 s32MilliSec);
