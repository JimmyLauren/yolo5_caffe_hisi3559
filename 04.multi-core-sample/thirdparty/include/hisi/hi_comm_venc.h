...
{
    HI_S32 s32RecvPicNum;                          /* RW; Range:[-1,0)U(0 4294967295]; Number of frames received and encoded by the encoding channel*/
...
{
    HI_S32 s32SrcFrmRate;                  /* RW; Range:[0,4294967295];Source frame rate of a non-ROI*/
    HI_S32 s32DstFrmRate;                  /* RE; Range:[0, s32SrcFrmRate]; Target frame rate of a non-ROI  */
