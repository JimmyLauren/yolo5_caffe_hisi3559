...
*   Parameters   : SVP_SRC_MEM_INFO_S   *pstModelBuf    Input model buf, can't be freed
...
*
*****************************************************************************/
HI_S32 HI_MPI_SVP_NNIE_LoadModel(SVP_SRC_MEM_INFO_S *pstModelBuf, SVP_NNIE_MODEL_S *pstModel);
...
HI_S32 HI_MPI_SVP_NNIE_GetTskBufSize(HI_U32 u32MaxInputNum, HI_U32 u32MaxBboxNum,
       SVP_NNIE_MODEL_S *pstModel, HI_U32 au32TskBufSize[], HI_U32 u32NetSegNum);
...
*                  SVP_SRC_BLOB_S                    astSrc[]             Input node array.
*                  SVP_NNIE_MODEL_S                  pstModel             CNN model data
*                  SVP_DST_BLOB_S                    astDst[]             Output node array
*                  SVP_NNIE_FORWARD_CTRL_S          *pstForwardCtrl       Ctrl prameters
...
HI_S32 HI_MPI_SVP_NNIE_Forward(SVP_NNIE_HANDLE *phSvpNnieHandle,
    SVP_SRC_BLOB_S astSrc[], SVP_NNIE_MODEL_S *pstModel, SVP_DST_BLOB_S astDst[],
    SVP_NNIE_FORWARD_CTRL_S *pstForwardCtrl, HI_BOOL bInstant);
...
*                  SVP_SRC_BLOB_S                    astSrc[]           Input nodes' array.
*                  SVP_SRC_BLOB_S                    astBbox[]          Input nodes' Bbox array.
*                  SVP_NNIE_MODEL_S                  pstModel           CNN model data
*                  SVP_DST_BLOB_S                    astDst[]           Output node array
*                  SVP_NNIE_FORWARD_WITHBBOX_CTRL_S *pstForwardCtrl     Ctrl prameters
*                  HI_BOOL                           bInstant           Flag indicating whether to generate an interrupt.
*                                                                       If the output result blocks the next operation,
*                                                                       set bInstant to HI_TRUE.
*   Spec         :
...
HI_S32 HI_MPI_SVP_NNIE_ForwardWithBbox(SVP_NNIE_HANDLE *phSvpNnieHandle,
    SVP_SRC_BLOB_S astSrc[], SVP_SRC_BLOB_S astBbox[], SVP_NNIE_MODEL_S *pstModel,
    SVP_DST_BLOB_S astDst[], SVP_NNIE_FORWARD_WITHBBOX_CTRL_S *pstForwardCtrl, HI_BOOL bInstant);
