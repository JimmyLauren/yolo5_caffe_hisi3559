...
typedef struct hiAVS_GRP_ATTR_S
{
    ...
    HI_U32               u32PipeNum;                    /* RW; Range: Hi3559AV100ES = [1, 6] | Hi3559AV100 = [1, 8] | Hi3556AV100 = [1, 4]; Pipe number. */
...
{
    HI_U32              u32Width;           /* RW; Range: Hi3559AV100ES = [256, 16384] | Hi3559AV100 = [256, 16384] | Hi3556AV100 = [256, 8192]; Width of target image. */
