...
HI_S32 HI_MPI_VENC_StartRecvFrame(VENC_CHN VeChn, VENC_RECV_PIC_PARAM_S *pstRecvParam);
...
HI_S32 HI_MPI_VENC_SetRoiAttr(VENC_CHN VeChn, VENC_ROI_ATTR_S *pstRoiAttr);
...
HI_S32 HI_MPI_VENC_SetRoiAttrEx(VENC_CHN VeChn, VENC_ROI_ATTR_EX_S *pstRoiAttrEx);
...
HI_S32 HI_MPI_VENC_SetJpegEncodeMode(VENC_CHN VeChn, VENC_JPEG_ENCODE_MODE_E enJpegEncodeMode);
...
HI_S32 HI_MPI_VENC_SetIntraRefresh(VENC_CHN VeChn, VENC_INTRA_REFRESH_S *pstIntraRefresh);
...
HI_S32 HI_MPI_VENC_SetChnParam(VENC_CHN VeChn,VENC_CHN_PARAM_S *pstChnParam);
...
HI_S32 HI_MPI_VENC_SetForegroundProtect(VENC_CHN VeChn,VENC_FOREGROUND_PROTECT_S *pstForegroundProtect);
...
HI_S32 HI_MPI_VENC_GetCuPrediction(VENC_CHN VeChn, const  VENC_CU_PREDICTION_S * pstCuPrediction);

HI_S32 HI_MPI_VENC_SetSkipBias(VENC_CHN VeChn, const  VENC_SKIP_BIAS_S * pstSkipBias);
HI_S32 HI_MPI_VENC_GetSkipBias(VENC_CHN VeChn, const  VENC_SKIP_BIAS_S * pstSkipBias);

HI_S32 HI_MPI_VENC_SetDeBreathEffect(VENC_CHN VeChn, VENC_DEBREATHEFFECT_S * pstDeBreathEffect);
