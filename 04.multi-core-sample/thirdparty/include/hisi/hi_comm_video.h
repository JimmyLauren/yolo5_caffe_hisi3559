...
typedef enum hiPIXEL_FORMAT_E
{
    ...
    PIXEL_FORMAT_YVU_SEMIPLANAR_420 = 25,
...
typedef struct hiDIS_MOTION_DATA_S
{
    HI_S32 s32MotionData[DIS_MOTIONDATA_NUM];
}DIS_MOTION_DATA_S;

typedef struct hDIS_MOTION_DATA_INFO_S
{
    DIS_MOTION_DATA_S stData;
    HI_BOOL bValid;
}DIS_MOTION_DATA_INFO_S;
typedef struct hiMOTION_DATA_S
{
    DIS_MOTION_DATA_INFO_S  stGmeMotionData;
    DIS_MOTION_DATA_INFO_S  stFliterMotionData;
    DIS_MOTION_DATA_INFO_S  stGyroMotionData;
} MOTION_DATA_S;
