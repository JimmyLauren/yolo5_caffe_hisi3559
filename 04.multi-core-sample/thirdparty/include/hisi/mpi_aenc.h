...
HI_S32 HI_MPI_AENC_RegisterEncoder(HI_S32 *ps32Handle, AENC_ENCODER_S *pstEncoder);
...
HI_S32 HI_MPI_AENC_GetStreamBufInfo(AENC_CHN AeChn, HI_U32* pu64PhysAddr, HI_U32* pu32Size);
