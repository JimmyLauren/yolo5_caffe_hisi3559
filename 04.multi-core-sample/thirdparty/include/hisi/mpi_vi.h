...
HI_S32 HI_MPI_VI_SetUserPic(VI_PIPE ViPipe, VI_USERPIC_ATTR_S *pstUsrPic);
...
HI_S32 HI_MPI_VI_ReleasePipeFrame(VI_PIPE ViPipe, VIDEO_FRAME_INFO_S *pstVideoFrame);
...
HI_S32 HI_MPI_VI_SetPipeNRXParam(VI_PIPE ViPipe, VI_PIPE_NRX_PARAM_S *pstNrXParam);
HI_S32 HI_MPI_VI_GetPipeNRXParam(VI_PIPE ViPipe, VI_PIPE_NRX_PARAM_S *pstNrXParam);

HI_S32 HI_MPI_VI_SetPipeRepeatMode(VI_PIPE ViPipe, VI_PIPE_REPEAT_MODE_E enPepeatMode);
...
HI_S32 HI_MPI_VI_ReleaseChnFrame(VI_PIPE ViPipe, VI_CHN ViChn, VIDEO_FRAME_INFO_S *pstFrameInfo);
