...
typedef enum hiDIS_MODE_E
{
    ...
    DIS_MODE_4_DOF_HYBRID,          /* Both use with GME and gyro in 4 dof */
    DIS_MODE_6_DOF_GME,             /* Only use with GME in 6 dof  */
    DIS_MODE_6_DOF_HYBRID,          /* Both use with GME and gyro in 6 dof */
    DIS_MODE_6_DOF_GYRO,            /* Only use with gryo in 6 dof  */
    DIS_MODE_DOF_BUTT,
} DIS_MODE_E;
...
typedef struct hiDIS_CONFIG_S
{
    ...
    HI_S32                  as32RotationMatrix[MATRIX_NUM];     /* RW; Rotation matrix for gyro sensor axes and image sensor axes */
