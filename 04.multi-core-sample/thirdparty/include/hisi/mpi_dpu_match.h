...
HI_S32 HI_MPI_DPU_MATCH_CreateGrp(DPU_MATCH_GRP DpuMatchGrp, DPU_MATCH_GRP_ATTR_S *pstGrpAttr);
HI_S32 HI_MPI_DPU_MATCH_DestroyGrp(DPU_MATCH_GRP DpuMatchGrp);
HI_S32 HI_MPI_DPU_MATCH_SetGrpAttr(DPU_MATCH_GRP DpuMatchGrp, DPU_MATCH_GRP_ATTR_S *pstGrpAttr);
...
HI_S32 HI_MPI_DPU_MATCH_SetChnAttr(DPU_MATCH_GRP DpuMatchGrp, DPU_MATCH_CHN DpuMatchChn, DPU_MATCH_CHN_ATTR_S *pstChnAttr);
...
HI_S32 HI_MPI_DPU_MATCH_ReleaseFrame(DPU_MATCH_GRP DpuMatchGrp, VIDEO_FRAME_INFO_S *pstSrcLeftFrame,
    VIDEO_FRAME_INFO_S *pstSrcRightFrame,VIDEO_FRAME_INFO_S *pstDstFrame);
HI_S32 HI_MPI_DPU_MATCH_SendFrame(DPU_MATCH_GRP DpuMatchGrp, VIDEO_FRAME_INFO_S *pstLeftFrame,
