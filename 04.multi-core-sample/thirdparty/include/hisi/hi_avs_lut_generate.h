...
Version       : Version 4.0 (for Hi3559A)
Created       : 2017/7/5
Last Modified :
...
#define AVS_LUT_SIZE  4194304   //4MB
#define AVS_CALIBRATION_FILE_LENGTH 10240
...
u64MaskVirAddr  : Virtual memory for saving each mask
*/
...
u64FileInputVirAddr:  Virtual memory for saving input calibration file
...
u64LutOutputVirAddr:  Virtual memory for saving each output lookup tables
*/
